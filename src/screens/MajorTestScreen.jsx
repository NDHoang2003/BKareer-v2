...
function MajorTest() {
  return (
    <body className="body card">
      ...
      <div className="font-20">Bài kiểm tra định hướng ngành nghề BKareer bao gồm 2 phần: Bài trắc nghiệm tính cách MBTI và Tìm hiểu về nhóm ngành yêu thích. Sau khi hoàn thành cả 2 phần trên, bạn sẽ khám phá được những điểm nổi trội của mình và nhận được gợi ý các thông tin ngành nghề - nghề nghiệp bạn nên ưu tiên tìm hiểu.</div>
      ...
      <div className="align-center margin-top-1rem">
